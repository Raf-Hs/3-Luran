  ...
  INSERT INTO `sucursal`(`id`, `ciudad`) VALUES ('1','Monterrey');
  INSERT INTO `sucursal`(`id`, `ciudad`) VALUES ('2','Guadalajara'); 
  INSERT INTO `sucursal`(`id`, `ciudad`) VALUES ('3','Querétaro'); 
